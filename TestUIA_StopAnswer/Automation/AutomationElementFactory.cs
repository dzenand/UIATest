...
namespace TestUIA.Automation
{
    internal class AutomationElementFactory : IAutomationElementFactory
    {
        ...
        public IAutomationElementWrapper GetRawViewWalkerParent(
        ...
        public IAutomationElementWrapper GetRawViewWalkerFirstChild(
            IAutomationElementWrapper element,
            CacheRequest cacheRequest = null)
        {
        ...
        public IAutomationElementWrapper GetRawViewWalkerNextSibling(
            IAutomationElementWrapper element,
            CacheRequest cacheRequest = null)
        {
            var automationElement = cacheRequest == null
